...
-   Watch files for changes, improving `#Includes` support ([thqby [#564](https://github.com/mark-wiemer-org/ahkpp/issues/564)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/564))
-   "Update File Version Info" now updates all `;@ahk2exe` directives as well ([thqby [#565](https://github.com/mark-wiemer-org/ahkpp/issues/565)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/565))
-   Context menu items organized into AHK++ submenu ([thqby [#570](https://github.com/mark-wiemer-org/ahkpp/issues/570)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/570))
...
-   Fix TraySetIcon definition ([thqby [#591](https://github.com/mark-wiemer-org/ahkpp/issues/591)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/591))
-   Fix ternary operator parsing ([thqby [#594](https://github.com/mark-wiemer-org/ahkpp/issues/594)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/594))
-   Improve completion provider for DllCall.Bind ([thqby [#595](https://github.com/mark-wiemer-org/ahkpp/issues/595)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/595))
-   Add Help and Sleep as key names ([thqby [#596](https://github.com/mark-wiemer-org/ahkpp/issues/596)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/596))
-   Fix debug when `launch.json` is present ([thqby [#584](https://github.com/mark-wiemer-org/ahkpp/issues/584)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/584))
-   Fix debug not using selected launch config ([thqby [#533](https://github.com/mark-wiemer-org/ahkpp/issues/533)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/533))
-   Fix "Update File Version Info" when more than one space is present ([thqby [#562](https://github.com/mark-wiemer-org/ahkpp/issues/562)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/562))
-   Fix "Update File Version Info" when placed after directive ([thqby [#563](https://github.com/mark-wiemer-org/ahkpp/issues/563)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/563))
-   Fix hover provider for `this` in classes ([thqby [#571](https://github.com/mark-wiemer-org/ahkpp/issues/571)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/571))
-   Fix formatting inside conditional function definition ([thqby [#574](https://github.com/mark-wiemer-org/ahkpp/issues/574)](https://github.com/thqby/vscode-autohotkey2-lsp/issues/574))
...
// settings.json
{
    ...
    // ⚠️ Not yet supported, ref [issue [#488](https://github.com/mark-wiemer-org/ahkpp/issues/488)](https://github.com/mark-wiemer-org/ahkpp/issues/488)
    "AHK++.v2.exclude": [],
    "AHK++.v2.file": {
        "compileBaseFile": "",
...
-   Add [full v2 integration docs](https://github.com/mark-wiemer-org/ahkpp/blob/HEAD/docs/FullV2Integration.md)
-   Clarify [license](https://github.com/mark-wiemer-org/ahkpp/blob/HEAD/license.md): even more open-source than before!
...
-   Add full v2 support via [thqby's AutoHotkey v2 Language Support](https://marketplace.visualstudio.com/items?itemName=thqby.vscode-autohotkey2-lsp)
    ...
    -   Known issues and all new features are documented at [full v2 integration](https://github.com/mark-wiemer-org/ahkpp/blob/HEAD/docs/FullV2Integration.md)
...
Full v2 support (IntelliSense, debugging, formatting) is coming later this month! ([Issue [#453](https://github.com/mark-wiemer-org/ahkpp/issues/453)](https://github.com/mark-wiemer-org/ahkpp/issues/453))
...
-   Add "PixelSearch" to V1 snippets ([PR [#427](https://github.com/mark-wiemer-org/ahkpp/issues/427)](https://github.com/mark-wiemer-org/ahkpp/pull/427))
-   Fix two minor formatting issues ([Issue [#432](https://github.com/mark-wiemer-org/ahkpp/issues/432)](https://github.com/mark-wiemer-org/ahkpp/issues/432), [#429](https://github.com/mark-wiemer-org/ahkpp/issues/429))
-   Update internal dependencies for security ([PR [#435](https://github.com/mark-wiemer-org/ahkpp/issues/435)](https://github.com/mark-wiemer-org/ahkpp/pull/435))

## 5.0.3 - 2023-08-21 🏄

-   Fix extension crash when switching to a nullish editor ([Issue [#398](https://github.com/mark-wiemer-org/ahkpp/issues/398)](https://github.com/mark-wiemer-org/ahkpp/issues/398))

## 5.0.2 - 2023-08-10 🐈

-   Fix language mode resetting when VS Code restarts ([Issue [#392](https://github.com/mark-wiemer-org/ahkpp/issues/392)](https://github.com/mark-wiemer-org/ahkpp/issues/392))

## 5.0.1 - 2023-08-08 😶‍🌫️

-   `ahk++.file.interpreterPathV2` now defaults to `C:/Program Files/AutoHotkey/v2/AutoHotkey64.exe` ([Issue [#387](https://github.com/mark-wiemer-org/ahkpp/issues/387)](https://github.com/mark-wiemer-org/ahkpp/issues/387))
-   Add breakpoint support for AHK v2 files ([Issue [#384](https://github.com/mark-wiemer-org/ahkpp/issues/384)](https://github.com/mark-wiemer-org/ahkpp/issues/384))
...
-   Allow `.ahk1` and `.ah1` extensions for v1 scripts, `.ahk2` and `.ah2` for v2 scripts. `.ahk` and `.ext` can be used for either version, but default to AHK v2 ([Issue [#396](https://github.com/mark-wiemer-org/ahkpp/issues/396)](https://github.com/mark-wiemer-org/ahkpp/issues/396))
    -   The original changelog entry mentioned that the shared file extensions defaulted to AHK v1--this was incorrect
    -   You can add a `#Requires AutoHotkey v1` directive to the top of an of `.ahk` file to have it automatically load in AHK v1 independent of VS Code settings ([Issue [#392](https://github.com/mark-wiemer-org/ahkpp/issues/392)](https://github.com/mark-wiemer-org/ahkpp/issues/392))
...
-   Missing features for AHK v2:
    -   Formatting ([Issue [#381](https://github.com/mark-wiemer-org/ahkpp/issues/381)](https://github.com/mark-wiemer-org/ahkpp/issues/381))
    -   Snippets ([Issue [#382](https://github.com/mark-wiemer-org/ahkpp/issues/382)](https://github.com/mark-wiemer-org/ahkpp/issues/382))
...
-   Add quick help, adapted from thqby's AutoHotkey v2 Language Support
    ...
    -   Known limitation: if selected text would cause a syntax error when injected into a script, help is activated but no search is made. [Issue [#376](https://github.com/mark-wiemer-org/ahkpp/issues/376)](https://github.com/mark-wiemer-org/ahkpp/issues/376)
...
-   IntelliSense no longer suggests words when a user presses space ([Issue [#110](https://github.com/mark-wiemer-org/ahkpp/issues/110)](https://github.com/mark-wiemer-org/ahkpp/issues/110))
...
-   Revert changes in 3.3.1. This release is the same as 3.3.0. Ref [Issue [#369](https://github.com/mark-wiemer-org/ahkpp/issues/369)](https://github.com/mark-wiemer-org/ahkpp/issues/369)

## 3.3.1 (yanked) - 2023-06-20 🌞

> This release has been yanked, meaning it's not supported. Use 3.3.3 instead.

-   Various syntax highlighting improvements ([PR [#354](https://github.com/mark-wiemer-org/ahkpp/issues/354)](https://github.com/mark-wiemer-org/ahkpp/pull/354), [PR [#358](https://github.com/mark-wiemer-org/ahkpp/issues/358)](https://github.com/mark-wiemer-org/ahkpp/pull/358))
-   Running `Open help` while `tutorial` text is selected now opens the Tutorial page ([PR [#348](https://github.com/mark-wiemer-org/ahkpp/issues/348)](https://github.com/mark-wiemer-org/ahkpp/pull/348))
-   Unexpected change: Break debugger.

## 3.3.0 - 2023-03-11 🪴

-   Add `ahk++.file.maximumParseLength` setting to support unlimited file size ([Issue [#117](https://github.com/mark-wiemer-org/ahkpp/issues/117)](https://github.com/mark-wiemer-org/ahkpp/issues/117))
...
-   Fix formatting for some bad labels (two colons) ([PR [#325](https://github.com/mark-wiemer-org/ahkpp/issues/325)](https://github.com/mark-wiemer-org/ahkpp/pull/325))
...
-   [Moving lines of code via commands](https://code.visualstudio.com/docs/getstarted/keybindings#_basic-editing) now (almost) correctly indents ([PR [#306](https://github.com/mark-wiemer-org/ahkpp/issues/306)](https://github.com/mark-wiemer-org/ahkpp/pull/306), issue [#319](https://github.com/mark-wiemer-org/ahkpp/issues/319))
-   Snippets and keywords updated to AutoHotkey v1.1.36.0 ([PR [#288](https://github.com/mark-wiemer-org/ahkpp/issues/288)](https://github.com/mark-wiemer-org/ahkpp/pull/288), [PR [#298](https://github.com/mark-wiemer-org/ahkpp/issues/298)](https://github.com/mark-wiemer-org/ahkpp/pull/298))

Fixes:

-   Fix syntax highlighting for:

    -   strings with double colons in them ([PR [#278](https://github.com/mark-wiemer-org/ahkpp/issues/278)](https://github.com/mark-wiemer-org/ahkpp/pull/278))
...
-   Fix formatting for:
    ...
    -   nested, unbraced code blocks ([PR [#287](https://github.com/mark-wiemer-org/ahkpp/issues/287)](https://github.com/mark-wiemer-org/ahkpp/pull/287))

-   Fix hover message for doc comments to always be trimmed ([PR [#308](https://github.com/mark-wiemer-org/ahkpp/issues/308)](https://github.com/mark-wiemer-org/ahkpp/pull/308))
...
-   Update file template: Add `#NoEnv` and `SetBatchLines, -1` ([PR [#202](https://github.com/mark-wiemer-org/ahkpp/issues/202)](https://github.com/mark-wiemer-org/ahkpp/pull/202))
...
-   Add [formatter directive](https://github.com/mark-wiemer-org/ahkpp/blob/HEAD/readme.md#formatter-directives) for "Format Block Comment" ([PR [#164](https://github.com/mark-wiemer-org/ahkpp/issues/164)](https://github.com/mark-wiemer-org/ahkpp/pull/164))
-   Add "allowed number of empty lines" setting to preserve any number of lines. Defaults to `1`, `-1` means "preserve all empty lines" ([PR [#194](https://github.com/mark-wiemer-org/ahkpp/issues/194)](https://github.com/mark-wiemer-org/ahkpp/pull/194))
-   Add "preserve indent" setting to preserve spaces before a comment. Defaults to `false`. ([PR [#192](https://github.com/mark-wiemer-org/ahkpp/issues/192)](https://github.com/mark-wiemer-org/ahkpp/pull/192))
-   Add "trim extra spaces" to trim spaces between words. Defaults to `true`. ([PR [#191](https://github.com/mark-wiemer-org/ahkpp/issues/191)](https://github.com/mark-wiemer-org/ahkpp/pull/191))
-   Trim end of line when formatting ([PR [#190](https://github.com/mark-wiemer-org/ahkpp/issues/190)](https://github.com/mark-wiemer-org/ahkpp/pull/190))

### Fixes

-   Fix some snippets ([PR [#138](https://github.com/mark-wiemer-org/ahkpp/issues/138)](https://github.com/mark-wiemer-org/ahkpp/pull/138), [PR [#201](https://github.com/mark-wiemer-org/ahkpp/issues/201)](https://github.com/mark-wiemer-org/ahkpp/pull/201), [PR [#210](https://github.com/mark-wiemer-org/ahkpp/issues/210)](https://github.com/mark-wiemer-org/ahkpp/pull/210))
-   Fix formatting bugs with semi-colon as part of a string ([PR [#159](https://github.com/mark-wiemer-org/ahkpp/issues/159)](https://github.com/mark-wiemer-org/ahkpp/pull/159))
-   Fix some formatting bugs with `if`, `else`, etc. without braces ([PR [#181](https://github.com/mark-wiemer-org/ahkpp/issues/181)](https://github.com/mark-wiemer-org/ahkpp/pull/181))
-   Fix formatter issue with non-label colon at end of line ([PR [#162](https://github.com/mark-wiemer-org/ahkpp/issues/162)](https://github.com/mark-wiemer-org/ahkpp/pull/162))
-   Even more formatter fixes ([PR [#164](https://github.com/mark-wiemer-org/ahkpp/issues/164)](https://github.com/mark-wiemer-org/ahkpp/pull/164))
-   Use default debug icon (was yanked in 2.8.3, now it returns!) ([PR [#149](https://github.com/mark-wiemer-org/ahkpp/issues/149)](https://github.com/mark-wiemer-org/ahkpp/pull/149))
...
-   Close [#126](https://github.com/mark-wiemer-org/ahkpp/issues/126)
